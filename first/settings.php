<?php
	$adresa="1726 Medical Blvd, Suite 204 | Naples, Fl 34110"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2395139990;// Broj koji se poziva na dugme CALL US
